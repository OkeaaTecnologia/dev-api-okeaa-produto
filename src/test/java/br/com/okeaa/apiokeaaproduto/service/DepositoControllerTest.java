...
import br.com.okeaa.apiokeaaproduto.controllers.DepositoController;
...
import br.com.okeaa.apiokeaaproduto.controllers.request.deposito.RetornoRequest;
...
import br.com.okeaa.apiokeaaproduto.controllers.response.deposito.RetornoResponse;
import br.com.okeaa.apiokeaaproduto.exceptions.deposito.ApiDepositoException;
import br.com.okeaa.apiokeaaproduto.exceptions.deposito.DetalhesErroResponse;
import br.com.okeaa.apiokeaaproduto.exceptions.deposito.ErroResponse;
...
//
//        String result = depositoController.createDeposit(xml).getBody();
//        assertEquals(resposta, result);
//    }
...
//
//        String result = depositoController.updateDeposit(xml, idDeposito).getBody();
//        assertEquals(resposta, result);
//    }
